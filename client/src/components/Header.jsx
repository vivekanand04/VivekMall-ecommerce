                    ...
                    <div className='container mx-auto flex items-center px-2 justify-between'>
                        ...
                        <div className='h-full'>
                            <Link to={"/"} className='h-full flex items-center gap-2 '>
                                ...
                                />
                             {/* <span className='text-2xl font-bold text-red-600'>Vivek</span><span className='text-2xl font-bold text-blue-600'>Mall</span> */}
 <h1 className="text-2xl font-bold">
  <span className="text-blue-600">Vivek</span>
